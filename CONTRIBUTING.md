...
If you've found an issue with the asset, please do report it through one of the following channels. If you have a GitHub account its recommended to report an issue. But other methods are available if you don't:
...
- Follow the Carter Games specific Unity file naming conventions for any new assets. Which can be found here: https://carter.games/unity-file-naming-conventions/
